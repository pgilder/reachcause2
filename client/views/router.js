...
Router.map(function () {
	...
	this.route("/dashboard", {name: "admin", title: "", controller: "AdminController"});
	this.route("/dashboard/users", {name: "admin.users", title: "", controller: "AdminUsersController"});
	this.route("/dashboard/users/details/:userId", {name: "admin.users.details", title: "", controller: "AdminUsersDetailsController"});
	this.route("/dashboard/users/insert", {name: "admin.users.insert", title: "", controller: "AdminUsersInsertController"});
	this.route("/dashboard/users/edit/:userId", {name: "admin.users.edit", title: "", controller: "AdminUsersEditController"});
